{ pkgs, ... }:
{
  ...
  programs.mangohud = {
    ...
    settings = {
      ...
      background_color           = "2F3549";
      media_player_color         = "9ECE6A";
      wine_color                 = "BB9AF7";
      battery_color              = "BB9AF7";
      network_color              = "BB9AF7";

      # base pallete tokyo-night
        # base00: #1A1B26
        # base01: #16161E
        # base02: #2F3549
        # base03: #444B6A
