...
wk.add({
    ...
    { "<leader>g", group = "Glow" },
    { "<leader>gp", "<cmd>lua require('plugins.glow-preview').toggle()<cr>", { desc = "Toggle glow preview" } },
    { "<leader>gu", "<cmd>lua require('plugins.glow-preview').update()<cr>", { desc = "Update glow preview" } },
})
